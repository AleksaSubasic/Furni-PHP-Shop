                                    ...
                                    <tbody>
                                        <?php foreach ($orderProducts as $prod) : ?>
                                            <tr>
                                                ...
                                                <td>&dollar;<?= $prod->subtotal_o_item ?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        <tr>
                                            <td class="text-black font-weight-bold"><strong>Shipping</strong></td>
                                            <td class="text-black">&dollar;14.99</td>
                                        </tr>
                                        <tr>
                                            <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                                            <td id="checkout-totalPrice" class="text-black font-weight-bold"><strong>&dollar;<?= $totalValue ?></strong></td>
                                        </tr>
                                    </tbody>
                                </table>
