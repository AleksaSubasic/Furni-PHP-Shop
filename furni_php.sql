...
--
-- Host: localhost
-- Generation Time: May 17, 2024 at 03:02 PM
...
(11, 'Admin', 'Admin', 'root.admin', 'admin@example.com', '$2y$10$xfE0Z3GenIaZLYiU6ckLCO0I68pCx5vZWSqDMCAN3qJztoEwDx.P.', '456 Park Avenue, New York', '1+000-000-0000', 1, 1, '2024-03-11 23:47:31', '0000-00-00 00:00:00'),
...
--
ALTER TABLE `image`
  MODIFY `id_image` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;
...
--
ALTER TABLE `orders_item`
  MODIFY `id_o_item` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `user_img`
  MODIFY `id_user_img` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
