                            ...
                            <div class="cart-item-container p-3 mb-3 border-10 d-flex w-100">
                                ...
                                <div class="item-details flex-grow-1 px-4">
                                    ...
                                    <div class="input-group d-flex align-items-center quantity-container flex-sm-row flex-column ">
                                        ...
                                        <p class="totalValue m-0 ms-3 text-black  me-auto">&dollar;<?= $prod->subtotal_o_item; ?></p>
                                    </div>
                                </div>
                ...
                <div id="shopping-cart-totals-info" class="h-100 d-flex flex-column p-3 border-10 ms-auto">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6 text-end">
                            <strong id="subtotalValue" class="text-black">&dollar;0.00</strong>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-6 text-end">
                            <strong id="shippingValue" class="text-black">&dollar;14.99</strong>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 text-end">
                            <strong id="totalValue" class="text-black">&dollar;0.00</strong>
                        </div>
                    </div>
